  ...
  return (
    <div className="w-full relative">
      <div className="sticky top-0 mb-1.5 flex items-center justify-between z-10 h-14 p-2 font-semibold bg-token-main-surface-primary bg-white">
        ...
        <button onClick={() => setMenuClose(!menuOpen)} className="z-40  md:hidden">
          <MobileMenuIcon />
        </button>
            ...
            <div className="flex w-full items-center">
              <div className="overflow-hidden flex flex-col w-full flex-grow relative border rounded-2xl">
                <textarea
                  ...
                  className="m-0 w-full focus:outline-none resize-none bg-transparent py-[10px] pr-10 md:py-3.5 md:pr-12 max-h-52 placeholder-black/50 pl-3 md:pl-4 rounded-lg"
                ></textarea>
